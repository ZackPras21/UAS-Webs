        ...
        <div class="wrapper">
            <nav>
                ...
                <ul class="nav-item">
                    ...
                    <li>
                        <a href="pages/bookinglogin.php">My Booking</a>
                    </li>
                    <li>
    ...
    <div class="menubar">
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="home text">
                    <form action="simpan.php" method="POST" class="row g-3 needs-validation">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="submit" value="Book Flights">
                        </div>
                    </form>
                </div>
                ...
                <form action="simpan.php" method="POST" class="row g-3 needs-validation">
                    ...
                    <div class="col-md-4">
                        <label for="validationbookhotels" class="form-label">Book Hotels</label>
                        <input type="submit"value="Book Hotels">
                    </div>
                    </form>
                </div>
                <div class="eats text">
                <form action="simpan.php" method="POST" class="row g-3 needs-validation">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="submit"value="Book Eats">
                    </div>
                </form>
                </div>
                ...
                <form action="simpan.php" method="POST" class="row g-3 needs-validation">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="submit" value="Book Trains">
                    </div>
                </form>
                </div>
                </div>
